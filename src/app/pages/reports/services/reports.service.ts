...
import { FinancialMetrics, PatientMetrics, ReportFilters } from "../models/reports.model";
...
@Injectable({
  ...
  export class ReportService {
    ...
    getFinancialMetrics(filters: ReportFilters): Observable<FinancialMetrics> {
      return this.http.get<FinancialMetrics>(`${this.apiUrl}/financial`, { params: this.getParams(filters) });
    }
  
    getPatientMetrics(filters: ReportFilters): Observable<PatientMetrics> {
      return this.http.get<PatientMetrics>(`${this.apiUrl}/patient`, { params: this.getParams(filters) });
    }
  
    getDepartmentMetrics(filters: ReportFilters): Observable<any> {
      return this.http.get<any>(`${this.apiUrl}/department`, { params: this.getParams(filters) });
    }
  
    getInventoryMetrics(filters: ReportFilters): Observable<any> {
      return this.http.get<any>(`${this.apiUrl}/inventory`, { params: this.getParams(filters) });
    }
  
    exportReport(type: string, filters: ReportFilters): Observable<Blob> {
